...
const faqEntries: FaqEntry[] = [
	...
	{
		id: 'add-filter',
		question: 'Hvordan tilføjer jeg et filter?',
		keywords: ['tilføj', 'filter', 'filtering'],
		answer:
			'For at tilføje et filter, klik på filter-ikonet i værktøjslinjen og vælg de kriterier, du ønsker at filtrere efter.',
		locale: 'da',
	},
]

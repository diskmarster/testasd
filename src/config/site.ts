...
export const siteConfig: SiteConfig = {
	...
	navItems: (
		lng: string = 'dk',
		settings: Pick<CustomerSettings, 'usePlacement'> = { usePlacement: true },
	) => [
		{
		...
		},
		{
			...
			items: [
				...
				{
					label: 'site-config.administration.location-move',
					description: 'site-config.administration.location-move-description',
					href: `/${lng}/administration/lokations-flyt`,
					roles: [],
					isExternal: false,
					isDisabled: false,
				},

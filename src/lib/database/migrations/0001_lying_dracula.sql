...
CREATE TABLE IF NOT EXISTS `nl_group` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`location_id` text NOT NULL,
	`name` text NOT NULL,
	`inserted` integer DEFAULT (unixepoch()) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `nl_history` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `nl_inventory` (
	`product_id` integer NOT NULL,
	`placement_id` integer NOT NULL,
	`batch_id` integer NOT NULL,
	`location_id` integer NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `nl_placement` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`location_id` text NOT NULL,
	`name` text NOT NULL,
	`inserted` integer DEFAULT (unixepoch()) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `nl_product` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`customer_id` integer NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `nl_unit` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`name` text NOT NULL,
	`inserted` integer DEFAULT (unixepoch()) NOT NULL,
	`updated` integer DEFAULT (unixepoch()) NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `nl_batch_location_id_batch_unique` ON `nl_batch` (`location_id`,`batch`);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `nl_group_location_id_name_unique` ON `nl_group` (`location_id`,`name`);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `nl_placement_location_id_name_unique` ON `nl_placement` (`location_id`,`name`);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `nl_product_customer_id_sku_unique` ON `nl_product` (`customer_id`,`sku`);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `nl_product_customer_id_barcode_unique` ON `nl_product` (`customer_id`,`barcode`);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `nl_unit_name_unique` ON `nl_unit` (`name`);

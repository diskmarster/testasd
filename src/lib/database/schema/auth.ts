...
export type UserWithAuth<TAuthDomain extends AuthProviderDomain> = User &
	GenericAuthProvider<TAuthDomain>
...
export interface GenericAuthProvider<TDomain extends AuthProviderDomain>

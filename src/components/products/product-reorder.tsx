...
export function ProductReorder({ productID, reorder, user }: Props) {
	...
	const { register, reset, handleSubmit } = useForm<z.infer<typeof schema>>({
			...
			<div
				...
				<div className='space-y-0.5 w-full'>
					...
					<IfElse
						...
						trueComp={<Input id='minimum' {...register('minimum' as const)} />}
					/>
				</div>
				<div className='space-y-0.5 w-full'>
					...
					<IfElse
						...
						trueComp={
							<Input id='orderAmount' {...register('orderAmount' as const)} />
						}
					/>
				</div>
				<div className='space-y-0.5 w-full'>

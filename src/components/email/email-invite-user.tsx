...
export function EmailInviteUser({
	company,
	link,
}: {
	company: string
	...
	return (
		<Tailwind>
			<Html>
				<Head />
				<Preview>
					{company} har inviteret dig til {siteConfig.name}
				</Preview>
					...
					<Container className='bg-white mx-auto pt-5 pb-12'>
						<Section className='px-12'>
							...
							<Text className='text-primary-foreground text-base leading-6 text-left'>
								Du er blevet inviteret til at oprette en konto på{' '}
								{siteConfig.name} som en del af {company}. Vi ser frem til at
								have dig med, og vi har gjort det nemt for dig at komme i gang.
							</Text>
							<Text className='text-primary-foreground text-base leading-6 text-left'>
								For at komme i gang og få mest muligt ud af vores system, bedes
								du oprette en bruger ved at klikke på knappen nedenunder. Dit
								link er aktivt i en uge.
							</Text>
							<Button

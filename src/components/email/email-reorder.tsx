		...
		<Tailwind>
			<Html>
				...
				<Body className='bg-muted font-sans'>
					<Preview>
						Der er vare som skal genbestilles i {siteConfig.name}
					</Preview>
					<Container className='bg-white mx-auto pt-5 pb-12'>
						<Section className='px-12'>
							...
							<Text className='text-primary-foreground text-base leading-6 text-left'>
								Der er varer i {siteConfig.name} som skal genbestilles til{' '}
								{mailInfo.locationName}.
							</Text>
							<Text className='text-primary-foreground text-base leading-6 text-left'>
								Du kan se de vare som skal genbestilles ved at tilgå dette{' '}
